...
# //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
def get_list_by_key(dictionary: dict, key: str) -> list:  # Проверка на dict???
    """
    ...
    try:
        ...
        input_list = rewrite_list_by_key(dictionary, key, [])  # Перезаписываем на пустой список
    else:
...
def is_car_correct(car: dict) -> bool:
    if isinstance(car, dict):  # Проверяем автомобиль на тип dict
        try:  # Пробуем получить данные автомобиля
            ...
            return is_id_number_correct(id_number)
    else:
        return False
# //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
def main(database: dict):
    ...
    delete_incorrect_data(cars, is_car_correct)

    drivers = get_list_by_key(database, DRIVERS)  # Получаем список водителей
    delete_incorrect_data(drivers, is_driver_correct)
